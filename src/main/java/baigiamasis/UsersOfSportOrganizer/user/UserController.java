...
//        Comments comments = restTemplate.getForObject("http://localhost:8081/news/article/" + id, Comments.class);
...
//    @GetMapping("/news/article/{id}/edit")
//    public String showArticleEdit(@PathVariable("id") int id, Model model) {
//        ResponseEntity<Article> responseEntity = restTemplate.getForEntity("http://localhost:8081/news/article/" + id, Article.class);
...
//    @PostMapping("/news/article/{id}/comment")
//    public String createComment(@PathVariable("id") int id, @ModelAttribute("comment") Comment comment, Model model) {
...
//            logger.info("Naujas komentaras sukurtas: {}", createdComment);
//        } else {
//            logger.error("Nepavyko sukurti komentaro");
//        }
//
//        return "redirect:/news/article/" + id;
//    }
...
//        ResponseEntity<List<SportType>> responseEntity = restTemplate.exchange(
//                "http://localhost:8081/news/sportTypes",
//                HttpMethod.GET,
//                null,
//                new ParameterizedTypeReference<List<SportType>>() {}
//        );
//        return responseEntity.getBody();
//    }
//
//    private SportType getSportTypeById(int id) {
//        return restTemplate.getForObject("http://localhost:8081/news/sportType/" + id, SportType.class);
//    }
